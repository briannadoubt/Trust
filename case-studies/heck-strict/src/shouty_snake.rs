...
pub trait ToShoutySnekCase: ToOwned {
    ...
    // reason: the method name TO_SHOUTY_SNEK_CASE intentionally uses
    // SCREAMING_SNAKE_CASE to match the convention of the output case it
    // performs; the name is part of the public API contract.
