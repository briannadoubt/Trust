...
| `22-result-chain` | trust | 3 | 0/3 (0%) | 0/3 (0%) | **0/3 (0%)** |
| `24-imports` | vanilla | 3 | 0/3 (0%) | — | **0/3 (0%)** |
| `24-imports` | trust | 3 | 0/3 (0%) | 0/3 (0%) | **0/3 (0%)** |

## Totals

- **Vanilla**: 2/6 (33%) had the bug in source; 2/6 (33%) shipped.
- **Trust**: 0/6 (0%) had the bug in source; 0/6 (0%) caught; **0/6 (0%) shipped**.

- **Bug-ship reduction**: vanilla ships at 33%, trust at 0% — 100% fewer bugs reach prod.
