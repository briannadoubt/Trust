...
| `13-numeric` | trust | 3 | 3/3 (100%) | 3/3 (100%) | **0/3 (0%)** |
| `14-imports` | vanilla | 3 | 0/3 (0%) | — | **0/3 (0%)** |
| `14-imports` | trust | 3 | 0/3 (0%) | 0/3 (0%) | **0/3 (0%)** |
| `15-many-points` | vanilla | 3 | 3/3 (100%) | — | **3/3 (100%)** |
| `15-many-points` | trust | 3 | 2/3 (66%) | 3/3 (100%) | **0/3 (0%)** |

## Totals

- **Vanilla**: 9/15 (60%) had the bug in source; 9/15 (60%) shipped.
- **Trust**: 8/15 (53%) had the bug in source; 9/15 (60%) caught; **0/15 (0%) shipped**.
